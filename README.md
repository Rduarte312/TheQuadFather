...
This is a small Python program I wrote for my CYB333. It checks how strong a password is and tells you what is wrong with it. It looks at the length, what kinds of characters are used, and whether the password is on a short list of very common passwords.
...
How to run it
python password_analyzerCYB333.py

It will ask you to type a password. Then it prints a score out of 6, a rating of Weak, Medium, or Strong, and a list of suggestions for anything it is missing. It keeps prompting so you can check more than one password in a row. Press Enter on a blank line to quit.
Example run:
Enter a password to check (or press Enter to quit): Hello123
...
I kept it simple on purpose. The point was to practice the basics: a for loop to go through each character, if/else checks, a while loop so you can test several passwords in a row, and a couple of small functions. I followed the general advice from NIST and OWASP that length and avoiding common passwords matter more than fancy rules, but I did not try to copy a full professional tool.
Notes
...
References
National Institute of Standards and Technology. (2025). Digital identity guidelines: Authentication and authenticator management (NIST Special Publication 800-63B, Revision 4). https://pages.nist.gov/800-63-4/sp800-63b.html
...
Author: Rodolfo Duarte and Marcos Ramirez
